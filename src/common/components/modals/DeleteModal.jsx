...
function DeleteModal({ isOpen, onClose, callBack, text, label, action, isDeleting, btnLabel }) {
            ...
            <div className="modal-content border-0">
              <div className="modal-content p-4">
                ...
                <div className="modal-header border-0">
                  <h4 className="modal-title text-dark fw-medium fs-15px">Delete widget</h4>
                ...
                <div className="modal-body">
                  <p>
                    This action will <span className="text-red">Delete</span>
                    {text}
                  </p>
