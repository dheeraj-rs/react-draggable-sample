...
function CarrierPlanListOutgoing({
  carrierPlan = '',
  planGroup = '',
  planDate = '',
  setShow,
  ...
  return (
    <div className="row bg-white border-transparent align-items-center p-2 p-lg-4 p-sm-2 py-4 py-lg-2 rounded mt-3 shadow-6 roles-box cursor-pointer mx-1 flex-wrap border">
      <div className="d-flex gap-3 gap-sm-2 gap-lg-3 align-items-center roles-list col-lg-3 col-sm-4 col-12 mb-lg-0 mb-3 mb-sm-0">
        ...
        <div className="d-flex gap-3 align-items-center">
          ...
          <Link
            // to="/comm-telephony/vendor-carrier-add-plan-outgoing"
...
export default CarrierPlanListOutgoing;
