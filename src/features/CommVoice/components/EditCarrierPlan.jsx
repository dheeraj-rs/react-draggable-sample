...
function EditCarrierPlan({ show, allCarrierGroups = [], setShow, formik, loading = false }) {
  const handleClose = () => {
    setShow({
      isVisible: false,
      type: '',
  ...
  return (
    <>
      <Modal width="435px" id="carrierPlanEditModal" show={show}>
        <div className="d-flex justify-content-between">
          <p className="fs-15px text-primary fw-medium mb-0">Edit Carrier Plan</p>
        ...
        <div className="form-group mt-3">
          <label className="text-primary mb-1">Add Carrier Plan</label>
          <select
...
export default EditCarrierPlan;
