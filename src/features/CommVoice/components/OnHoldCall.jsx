      ...
      <div className="card card shadow-6 p-23px bg-haiti border-0 rounded position-relative">
        <div className="d-flex gap-3">
          ...
          <div className="d-flex flex-column">
            <p className="mb-0 fw-medium fs-13px text-white">On Hold</p>
            <p className="mb-0 fs-20px text-white">
              00:00:45 <span className="ps-2 fs-12px"> +1 9834527645</span>
            </p>
            {/* <!-- call options --> */}
            <div className="mt-3 d-flex gap-4">
              <div className="d-flex flex-column align-items-center justify-content-center fs-11px h-6 w-6 rounded fw-semibold bg-white">
                <img src="/assets/mic-black.svg" alt="" />
              </div>
              <div className="d-flex flex-column align-items-center justify-content-center fs-11px h-6 w-6 rounded fw-semibold bg-white">
                <img src="/assets/play-black.svg" alt="" />
              </div>
              <div className="d-flex flex-column align-items-center justify-content-center fs-11px h-6 w-6 rounded fw-semibold bg-white">
                <img src="/assets/record-black.svg" alt="" />
              </div>
            </div>
            {/* <!-- call options --> */}
          </div>
