...
function ConnectingDIDCall({ isConnectingDIDCall, setIsConnectingDIDCall }) {
  return (
    <div
      id="callConnection"
      className={`col-sm-3 start-call ${isConnectingDIDCall.show ? '' : 'd-none'}`}
    >
      <div className="card card shadow-6 p-23px bg-haiti border-0 rounded position-relative">
        <div className="d-flex gap-3">
          ...
          <div className="d-flex flex-column">
            <p className="mb-0 fw-medium fs-13px text-white">Connecting DID Call</p>
            <p className="mb-0 fs-20px text-white">{isConnectingDIDCall.mobile}</p>
            {/* <!-- bubble loading --> */}
        ...
        <div className="d-flex">
          <div className="w-100 mt-5">
            <button
              ...
              onClick={() => {
                setIsConnectingDIDCall({ show: false, mobile: '' });
              }}
            >
...
export default ConnectingDIDCall;
