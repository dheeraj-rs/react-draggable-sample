  ...
  return (
    <>
      <div
        ...
        tabIndex="-1"
        id="offcanvasEditLocalSwitch"
        aria-labelledby="offcanvasEditLocalSwitchLabel"
      >
        <div className="add-local-switch">
          <div className="offcanvas-header p-23px pb-10px justify-content-between align-items-center">
            <div>
              <p className="fs-16px text-primary fw-medium mb-0">Edit Local Switch</p>
            </div>
            <div>
              <button
                type="button"
...
export default EditLocalSwitch;
