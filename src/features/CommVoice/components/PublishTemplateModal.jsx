...
function PublishTemplateModal({ show, actionKey, onClose, handleAction, isProcessing }) {
    ...
    return (
      <Modal show={show} width="450px" id="publishFlow">
        <div className="d-flex justify-content-between">
          <p className="fs-16px text-primary fw-medium fs-16px mb-24px">Publish Templates</p>
        ...
        <p className="fs-13px text-primary mb-2">
          This action will publish the
          <span className="fw-medium">&nbsp;Call Flow</span> templates to the system
        </p>
        ...
        <div className="d-flex justify-content-start align-items-center border-0 p-0 mt-4">
          ...
          >
            {isProcessing ? 'Loading...' : 'Publish Templates'}
          </button>
