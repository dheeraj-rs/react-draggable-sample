...
function ContactsCompanyGroup({
  ...
  return (
    <div
      className={`hover-effect d-flex align-items-center rounded p-16px gap-13px round false ${
...
export default ContactsCompanyGroup;
