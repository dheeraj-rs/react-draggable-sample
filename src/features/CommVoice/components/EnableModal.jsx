...
function EnableModal({ show, actionKey, onClose, handleAction, isProcessing, name }) {
    ...
    return (
      <Modal show={show} width="450px" id="disableModal">
        <div className="d-flex justify-content-between">
          <p className="fs-16px text-primary fw-medium fs-16px mb-24px">Enable Template</p>
          <ModalClose onClose={handleOnClose} />
        </div>
        <p className="fs-13px text-primary mb-2">
          This action will enable the selected call flow template{' '}
        ...
        <div className="p-3 bg-aqua-squeeze rounded d-flex gap-2 mt-3">
          ...
          <div>
            <p className="mb-0 text-mariner">
              Once Enabled the template It will be visible to the customers panel.
            </p>
          </div>
        </div>
        <Input
