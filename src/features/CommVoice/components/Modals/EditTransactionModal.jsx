...
function EditTransactionModal({ show, onClose, formik }) {
          ...
          <div className="modal-content border-0">
            <div className="modal-content p-lg-4 p-2">
              ...
              <div className="modal-header border-0 pb-0">
                <h4 className="modal-title text-dark fw-medium fs-15px">Edit Transaction</h4>
              ...
              <div className="modal-body pt-1">
                <div className="row d-flex align-items-end justify-content-between">
                  ...
                  <div className="col-lg-6 mt-3">
                    ...
                    >
                      <option defaultValue>Bank Transfer</option>
