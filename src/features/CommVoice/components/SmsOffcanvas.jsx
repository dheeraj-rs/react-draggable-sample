...
function SmsOffcanvas({ setToastAction, show, setShow }) {
  const hanldeClose = () => {
        ...
        >
          ...
          <div className="offcanvas-body px-4">
            ...
            <Select
              label="SMS Sender ID"
              id="sms"
              options={['600231 (LMSNF)', '600231 (LMSNF)', '600231 (LMSNF)', '600231 (LMSNF)']}
              onchange={() => {}}
            />
            <div className="form-group form-custom-group mt-3">
              <Select
                label="Recipients"
                id="sms"
                options={['600231', '600232', '600233', '600234']}
                onchange={() => {}}
              />
            </div>
            ...
            <a
              ...
              onClick={(e) => {
                e.preventDefault();
                setShow({ isVisible: true, type: 'sms-template-offcanvas' });
              }}
            ...
            <div className="d-flex justify-content-start align-items-center gap-2 border-0 ps-0 mt-5">
              <button
                ...
                // onClick={() => {
                //   setToastAction({ isVisible: true, message: 'Message sent', type: 'sent' });
                // }}
              >
                <span className="pe-2">
                  <svg
