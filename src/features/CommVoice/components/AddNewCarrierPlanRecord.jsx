...
function AddNewCarrierPlanRecord({
  carrierPlanName,
  show,
  onClose,
  formik,
                ...
                <div className="modal-header border-0">
                  <div className="d-flex gap-3 align-items-center">
                    <h4 className="modal-title text-dark fw-medium fs-15px">
                      Add New Record - <span className="text-secondary">{carrierPlanName}</span>
                    </h4>
                  </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <select
                              ...
                              value={parseInt(formik.values.city, 10) || 'select'}
                            >
                              <option value="select" disabled>
                                City
                              </option>
...
export default AddNewCarrierPlanRecord;
