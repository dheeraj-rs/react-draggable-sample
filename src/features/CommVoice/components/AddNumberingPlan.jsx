...
function AddNumberingPlan({ show, onClose, formik, dataSubmitting }) {
              ...
              <div className="modal-content p-23px">
                ...
                <div className="modal-header border-0 p-0">
                  <div className="d-flex flex-column">
                    <h4 className="modal-title text-dark fw-medium fs-15px">Add Numbering Plan</h4>
                  </div>
                ...
                <div className="d-flex align-items-center gap-2 border-0 ps-0 mt-4">
                  <button
                    // href="/comm-telephony/vendor-did/"
                    href="/#"
                    id="addSlabButton"
                    type="button"
                  ...
                  >
                    {dataSubmitting ? 'Adding...' : 'Add plan'}
                  </button>
...
export default AddNumberingPlan;
