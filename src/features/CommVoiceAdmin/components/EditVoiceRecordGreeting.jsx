...
function EditVoiceRecordGreeting({
  formik,
  setEditVoiceType,
  editVoiceType,
  onClose,
  ...
  const [selectedGender, setSelectedGender] = useState('female4');
  ...
  useEffect(() => {
    setAudioBlob(null);
    handleRecordingStop();
    formik.setFieldValue('recordIvrDescription', '');
  }, [
  ...
  return (
    <div id="addVoiceRecordWrap">
          ...
          <div className="record-voice-radio rounded">
            ...
            <label
              ...
              onClick={() => {
                ...
                setEditVoiceType({ isVisible: true, type: 'change-ivr-record-voice' });
              }}
            >
              Custom IVR
            </label>
              ...
              <div className="d-flex gap-3 mt-2">
                <div>
                  <input
                    ...
                    name="Gender4"
                    type="radio"
                    checked={selectedGender === 'female4'}
                    onChange={handleGenderChange}
                  />
                  <label htmlFor="female4" className="radio-tick-label text-primary">
                    Female
                  </label>
                </div>
                <div>
                  <input
                    ...
                    name="Gender4"
                    type="radio"
                    checked={selectedGender === 'male4'}
                    onChange={handleGenderChange}
                  />
                  <label htmlFor="male4" className="radio-tick-label text-primary">
                    Male
                  </label>
                </div>
              </div>
      ...
      <div id="customIVRSuccess" className={`mt-4 ${editVoiceType?.ivr === 'ivr' ? '' : 'd-none'}`}>
...
export default EditVoiceRecordGreeting;
