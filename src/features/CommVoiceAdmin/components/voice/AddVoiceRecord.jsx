  ...
  return (
    <div id="addVoiceRecordWrap">
      ...
      <div id="fromMobile" className="mt-4 d-none">
        ...
        <div id="mobileRecord">
          <Input label="Enter your phone number" value="1234567890" onChange={() => {}} />
          <button
            id="callRecordBtn"
            type="button"
      ...
      <div id="fromIVR" className="mt-4 d-none">
        <div id="customIVRWrap">
          ...
          <div className="d-flex flex-column flex-md-row align-items-sm-center align-items-start gap-30 mt-2">
            <div>
