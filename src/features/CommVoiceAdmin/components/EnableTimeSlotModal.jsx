...
function EnableTimeSlotModal({ show, actionKey, onClose, action, title, isProcessing }) {
            ...
            <div className="modal-content border-0">
              <div className="modal-content p-4">
                <div className="modal-header border-0">
                  <h4 className="modal-title text-dark fw-medium fs-15px">Enable TimeSlot</h4>
                ...
                <div className="modal-body">
                  <p>
                    This action will enable the selected time slot <b>{title}</b> from the time slot
                    list.
                  </p>
...
export default EnableTimeSlotModal;
