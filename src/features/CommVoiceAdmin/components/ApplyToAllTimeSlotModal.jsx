...
function ApplyToAllTimeSlotModal({ show, actionKey, onClose, action, title, isProcessing }) {
            ...
            <div className="modal-content border-0">
              <div className="modal-content p-4">
                <div className="modal-header border-0">
                  <h4 className="modal-title text-dark fw-medium fs-15px">Apply to All</h4>
                ...
                <div className="modal-body">
                  <p>
                    This action will apply the selected timeslots <b>{title}</b>to all days.
                  </p>

                  <InputModal
                    label="To confirm this action please type “Apply”"
                    id="AgentXYZ"
...
export default ApplyToAllTimeSlotModal;
