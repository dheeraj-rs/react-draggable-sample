...
function Email() {
  ...
  return (
    ...
    >
      <NodeHeader
        name="Email"
        icon="/assets/call-flows-icons/email.svg"
        type="email"
        actionType="edit-node"
        headerbg="cool-mint"
        iconbg="light-sky-blue"
        nodeId={nodeId}
        tooltipContent="The Email component mails a group email id or a user with all the details of the call info on who called, what time, what they input"
      >
      ...
      <ul className="bg-white" style={{ borderRadius: '10px' }}>
        <li
          ...
          onClick={() => {
            setSelectedNode({ nodeId, type: 'after-email-sent', sourceIndex: 1 });
          }}
        >
          ...
          <HandleSourceRight
            ...
            nodeId={nodeId}
            type="after-email-sent"
            isVisible={isValueInArray('after-email-sent', activeEdges)}
          />
        </li>
      </ul>
    </div>
