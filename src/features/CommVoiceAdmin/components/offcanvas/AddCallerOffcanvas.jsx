...
function AddCallerOffcanvas({ formik, show, onClose, carriers, dataSubmitting, callerList = [] }) {
  ...
  return (
    <>
      <div
        ...
        tabIndex="-1"
        id="offcanvasAddCaller"
        aria-labelledby="offcanvasAddCallerLabel"
      >
        ...
        <div className="offcanvas-body p-23px pt-0px">
          ...
          <div className="d-flex justify-content-start align-items-center border-0 ps-0 mt-4">
            <button
              id="addCallerToast"
              data-bs-dismiss="offcanvas"
              type="button"
            ...
            >
              {dataSubmitting ? 'Adding...' : 'Add Caller'}
            </button>
            <button
              type="button"
...
export default AddCallerOffcanvas;
