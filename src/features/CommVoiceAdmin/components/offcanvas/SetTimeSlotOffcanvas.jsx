  ...
  return (
    <>
      <div
        ...
        tabIndex="-1"
        id="offcanvasSetTime"
        aria-labelledby="offcanvasSetTimeLabel"
      >
        ...
        <div className="offcanvas-body p-23px pt-0px">
                      ...
                      <a
                        ...
                        onClick={(e) => {
                          ...
                          setShow({
                            ...
                            deleteType: 'set-delete-timeslot-modal',
                            id: timeslot.id,
                            slotIndex: index,
          ...
          <div className="d-flex align-items-center gap-3 flex-wrap border-0 ps-0 mt-5">
            ...
            <a
              href="/#"
              className="blue-btn d-flex align-items-center  px-3 py-12px rounded border border-blue-active"
              onClick={(e) => {
                e.preventDefault();
                // handleApplyToAll();
                setShow({
...
export default SetTimeSlotOffcanvas;
