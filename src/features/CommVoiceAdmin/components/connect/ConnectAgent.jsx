...
function ConnectAgent({
  ...
  return (
    <div id="connect-agent-outer" className={show ? '' : 'd-none'}>
      ...
      <div className="row mt-3">
        ...
        <div className="col-md-6">
          <div className="call-duration">
            {/* <div className="d-flex align-items-center justify-content-between ">
              <h6 className="fs-13px fw-600 m-0">API</h6>
              <CheckboxTick
                checked={}
                onChange={() => {}}
                onClick={() => {
      ...
      <div className="row mt-3">
        <div className="col-md-6">
          <p className="my-2 text-primary fs-13px">
            Play background music when call connecting (agent)
          </p>
          <CustomIVR
            ...
            onPause={onPause}
            // categoryId={
            //   getVoiceFileDetails(allAvailableVoices, formik?.values?.musicWhenCallConnectingId)
            //     ?.attributes?.category_id
            // }
            // fileId={formik?.values?.musicWhenCallConnectingId}
