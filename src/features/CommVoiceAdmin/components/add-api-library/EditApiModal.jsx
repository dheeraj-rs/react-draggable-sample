...
function EditApiModal({ show, formik, onClose, loading }) {
    ...
    <>
      ...
      >
        <div className="offcanvas-header offcanvas-header-title p-23px pb-10px justify-content-between align-items-center">
          <div>
            <p className="fs-16px text-primary fw-medium mb-0">Edit API</p>
          </div>
          <div>
        ...
        <div className="offcanvas-body p-23px pt-0px">
          ...
          <div className="d-flex gap-3 align-items-center mt-3" role="button">
