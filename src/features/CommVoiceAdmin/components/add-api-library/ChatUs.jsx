...
import ChatWidgetLeft from '../../../ChatWidget/chat-widget-settings/ChatWidgetLeft';
import ChatWidgetRight from '../../../ChatWidget/chat-widget-settings/ChatWidgetRight';

function ChatUs({ onClose }) {
  return (
    <div className="bg-white rounded-top border-0 fs-12px pb-lg-3 mt-lg-3 pb-xl-4 sample-article-new">
      <div className="border-0 shadow-8 rounded-bottom">
        <div className="change d-flex align-items-start p-3 py-4 fs-12px shadow-8 blue-widget rounded-top justify-content-between">
          <div id="heading">
            <div className="d-flex align-items-center text-white justify-content-center gap-3">
              <div className="">
                <a href="#/">
                  <img alt="" src="/assets/headphone.svg" />
                </a>
              </div>
              <div className="d-flex flex-column">
                <span className="text-white fs-17px fw-bold">Welcome to Gsoft</span>
              </div>
            </div>
          </div>
          <div className="">
            <a href="#/" role="button" onClick={onClose} className="p-1">
              <img alt="" src="/assets/Linegray.svg" className="" />
            </a>
          </div>
        </div>

        {/* <!-- article detail --> */}
        <div className="rounded-bottom scroll-wrap-right scroll-chat-area scroll-custom support-article-top">
          {/* <!-- articles --> */}
          <div className="article-wrap">
            <div className="accordion-body rounded-bottom p-0">
              <div className="p-3">
                  ...
                  <div className="chat-left">
                    <div className="d-flex flex-row gap-2">
                      <div className="">
                        ...
                        >
                          <rect width="22" height="22" rx="11" fill="#656565" />
                          <path
                            ...
                            <div className="chat-border-left bg-chat-blue p-3 d-flex flex-column align-items-end gap-2 mb-1">
                              <div>
                                <div className="d-flex gap-3">
                                  <div>
                                    <img alt="" src="/assets/CalendarCheck.svg" />
                                  </div>
                                  <div>
                      ...
                      <div className="chat-cvr d-flex align-items-end w-100 justify-content-end">
                        <div className="d-flex flex-column align-items-end">
                          ...
                          <div className="w-100 justify-content-end align-items-center mt-2">
                            <div className="chat-border-right bg-light-violet-color text-white px-2 py-1 d-flex flex-column align-items-end gap-2 mb-1">
                              <div className="d-flex align-items-center gap-3">
                                <div className="bg-white rounded">
                                  <img alt="" src="/assets/pdfwhite.svg" />
                                </div>
                                <div>
                                ...
                                <a href="#/" className="">
                                  <img alt="" src="/assets/DownloadSimpleIcon.svg" />
                                </a>
                              </div>
                            </div>
                            <div className="d-none chat-upload-progress chat-border-right bg-light-violet text-white px-2 py-1 d-flex flex-column align-items-end gap-2 mb-1 alert alert-dismissible">
                              <div className="d-flex align-items-center gap-3">
                                <div className="">
                                  <img alt="" src="/assets/uploadProgrees.svg" />
                                </div>
                                <div>
                                  <h6 className="fs-13px mb-0 text-primary">Sample document.pdf</h6>
                                  <p className="mb-0 fs-12px text-secondary">Sending...</p>
                                </div>
                                <a href="#/" data-bs-dismiss="alert" aria-label="Close">
                                  <img alt="" src="/assets/close-upload.svg" />
                                </a>
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="d-flex align-items-start">
                      <div className="chat-cvr d-flex align-items-end w-100 justify-content-end">
                        <div className="d-flex flex-column align-items-end">
                          ...
                          <div className="text-secondary mt-2">1 sec ago</div>
                        </div>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="mt-3 border chat-area-config pt-3">
                  <div className="d-flex gap-2 px-2 d-none chat-area-upload">
                    <div className="upload-chat-document position-relative alert p-0 mb-0">
                      <a href="#/" data-bs-dismiss="alert" aria-label="Close">
                        <div className="close-pdf cursor-pointer">
                          <img alt="" src="/assets/close-pdf.svg" />
                        </div>
                      </a>
                      <div className="document-chat">
                        <img alt="" src="/assets/pdf-icon-red.svg" />
                      </div>
                    </div>
                  ...
                  <div className="d-flex align-items-start pt-2">
                    <textarea
                      className="chatTextBox chat-type-input bg-transparent border-0 fs-12px ps-2"
                    ...
                    <div className="ms-auto d-flex align-items-center gap-2 pe-2">
                      <div>
                        ...
                        >
                          <i className="me-2">
                            <img alt="" height="20" src="/assets/smiley-icon.svg" />
                          </i>
                        </a>
                      </div>
                      <div>
                        <a id="file-system" className="d-flex me-2" href="#/">
                          <label htmlFor="file-input-chatarea">
                            <img
                              alt=""
                              src="/assets/file-attachement.svg"
                              className="cursor-pointer"
                            />
                          </label>

                          <input className="d-none" id="file-input-chatarea" type="file" />
                        </a>
                      </div>
                      <div>
                        <a className="chatSendBtn" href="#/">
                          <img alt="" src="/assets/chat-send.svg" />
                        </a>
                      </div>
                    </div>
                  </div>
          ...
          <div>
            <p className="text-center mt-3 text-dark-blue-bb pb-4">
