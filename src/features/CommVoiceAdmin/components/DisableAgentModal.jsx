...
function DisableAgentModal({ show, actionKey, onClose, action, title, isProcessing }) {
            ...
            <div className="modal-content border-0">
              <div className="modal-content p-4">
                <div className="modal-header border-0">
                  <h4 className="modal-title text-dark fw-medium fs-15px">Disable Agent</h4>
                ...
                <div className="modal-body">
                  <p>
                    This action will disable the selected agent <b>{title}</b> into the agent list.
                  </p>
