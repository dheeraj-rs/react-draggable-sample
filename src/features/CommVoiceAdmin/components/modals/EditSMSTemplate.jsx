...
function EditSMSTemplate() {
  return (
    <Modal width="705px" id="editSMSTemplate">
      <div className="d-flex justify-content-between">
        <p className="fs-14px text-primary fw-medium fs-16px mb-24px">Edit SMS Template</p>
        <ModalClose />
      </div>
      <p className="fs-13px text-secondary mb-0">
        Edit SMS template based on the DLT approved format.
      </p>
      ...
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
        ...
        <div className="w-100 newCarrier">
          <Input type="text" label="DLT Template ID" placeholder="Enter ID" />
        </div>
      </div>
