...
function AddVoiceUploadGreeting({
  formik,
  voiceType,
  isLoading,
  onClose,
    ...
    if (audioBlob) {
      ...
      audioRef.current.addEventListener('canplaythrough', () => {
        ...
        if (!Number.isNaN(duration)) {
          formik.setFieldValue('uploadFile', audioRef?.current?.src);
        } else {
      ...
      <div className="mt-3">
        ...
        {audioBlob && (
          <div id="voiceUploadComplete">
            ...
            {getFormErrorMessage(formik, 'uploadFile')}
            ...
            <div className="position-relative">
              <div className="form-group mt-4">
                ...
                <textarea
                  ...
                  rows="4"
                  placeholder="This voice is used for greetings"
...
export default AddVoiceUploadGreeting;
