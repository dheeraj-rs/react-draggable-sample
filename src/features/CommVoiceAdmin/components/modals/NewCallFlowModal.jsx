...
function NewCallFlowModal({ formik, show, onClose, isLoading }) {
  const handleClose = () => {
    onClose();
  };
  return (
      ...
      >
        <div className="modal-dialog">
          <div className="modal-content border-0">
            <div className="modal-content-x p-4">
              {/* <!-- Modal Header --> */}
              <div className="modal-header border-0">
                <h4 className="modal-title text-dark fw-medium fs-15px">New Call Flow</h4>
