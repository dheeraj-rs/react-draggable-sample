...
function NewCallerListModal({ show, onClose, formik, dataSubmitting }) {
  const handleClose = () => {
    formik.resetForm();
    onClose();
  };
    ...
    <>
      <Modal width="450px" id="addNewCategory" show={show}>
        <div className="d-flex justify-content-between">
          <p className="fs-14px text-primary fw-medium fs-16px mb-24px">New Caller list</p>
          <ModalClose onClose={handleClose} />
        </div>
        <p className="fs-13px text-secondary mb-0">Provide a unique list name</p>
...
export default NewCallerListModal;
